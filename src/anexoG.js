...
import nifPt from './nifPt.json';

// ISIN do emitente -> NIF da entidade emitente. A AT exige o NIF do emitente no Anexo G; não é
// derivável do ISIN. A tabela (src/nifPt.json) cobre as cotadas na Euronext Lisboa e emitentes
// saídos de bolsa; cada NIPC foi confirmado em fonte oficial. Pode ser refrescada/verificada com
// `npm run gen:nif` (script scripts/generate-nif-table.mjs, via GLEIF). ISIN não listado => aviso.
const nifFor = (isin) => (nifPt[isin] && nifPt[isin].nipc) || '';
